            ...
            <div className='mobile-menu block md:hidden'>
                {
                    openMenu ? (
                        ...
                        <button onClick={() => {setOpenMenu(true)}} className='flex items-center px-3 py-2 border rounded border-slate-200 text-slate-200 hover:text-white hover:border-white'>
